...
export const pluginList = ["MultiWorld", "PurePerms", "PureChat", "ExamplePlugin"];

console.log("[PMMPCore] Plugin loader initialized - MultiWorld, PurePerms, PureChat, ExamplePlugin loaded");
